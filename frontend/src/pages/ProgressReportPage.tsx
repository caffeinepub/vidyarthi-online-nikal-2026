  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-xl font-bold text-foreground devanagari">प्रगती पत्रक</h1>
      ...
      <div className="bg-card rounded-2xl shadow-card border border-border p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div>
            ...
            <Select value={udise} onValueChange={v => { setUdise(v); setClassName(''); setDivision(''); setAttendanceNo(''); setReportData(null); }}>
              <SelectTrigger>
          ...
          <div>
            ...
            <Select value={className} onValueChange={v => { setClassName(v); setDivision(''); setAttendanceNo(''); setReportData(null); }} disabled={!udise}>
              <SelectTrigger>
                <SelectValue placeholder="निवडा" />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            ...
            <Select value={division} onValueChange={v => { setDivision(v); setAttendanceNo(''); setReportData(null); }} disabled={!className}>
              <SelectTrigger>
                <SelectValue placeholder="निवडा" />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            ...
            <Select value={attendanceNo} onValueChange={v => { setAttendanceNo(v); setReportData(null); }} disabled={!division}>
              <SelectTrigger>
                <SelectValue placeholder="निवडा" />
              </SelectTrigger>
              <SelectContent>
