...
import type { SchoolExtra } from "../lib/localStorage";
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={openAdd}
          className="gradient-orange text-white border-0 rounded-xl gap-2 hover:opacity-90"
        >
          <Plus size={16} />
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow>
                  ...
                  >
                    कोणतीही शाळा नाही. नवीन शाळा जोडा.
                  </TableCell>
                </TableRow>
              ) : (
                schools.map((s) => (
        ...
        <DialogContent className="max-w-md rounded-2xl">
          <DialogHeader>
            <DialogTitle className="devanagari">
              {editItem ? "शाळा माहिती संपादित करा" : "नवीन शाळा जोडा"}
            </DialogTitle>
          </DialogHeader>
